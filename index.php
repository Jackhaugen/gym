            ...
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  <a class="nav-link" href="why.php">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item ">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-6">
          <div class="form_container pr-0 pr-lg-5 mr-0 mr-lg-2">
            ...
            <?php
error_reporting(1);
extract($_POST); // Added a semicolon here
include('connection.php');
if(isset($sub)){ // Corrected parentheses and added a dollar sign before 'sub'
    $query = "insert into contact values('', '$n', '$e', '$p', '$m')";
    $con->query($query);
    echo "<script> window.location.herf='display.php'</script>"; // Added a semicolon and corrected the message
}
?>
